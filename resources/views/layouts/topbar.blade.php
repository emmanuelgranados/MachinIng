...
@section('topbar')
    ...
    <header class="topbar">
        ...
        <div class="navbar-header border-end">
            ...
            <!-- Logo icon -->
            <b class="logo-icon">
           <!-- C:\xampp\htdocs\MACHINING\prueba\public\assets\images\logos\RI.jpeg 
                <img src="../../assets/images/logos/RI.jpeg" alt="homepage" class="light-logo" />--> 
            </b>
            <!--End Logo icon -->
            <!-- Logo text -->
            <span class="logo-text" style=" background-repeat: no-repeat;
            background-position: center center;
            background-attachment: fixed;
            opacity: 0.5;">
                <!-- dark Logo text -->
                <img src="../../assets/images/logos/RI.jpeg" width= 250px height=70px alt="homepage" class="dark-logo" />
                <img src="../../assets/images/logos/RI.jpeg" width= 250px height=70px class="light-logo" alt="homepage" />
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent" >
            ...
            <li class="nav-item dropdown">
                ...
                >
                    <div class="">
                    {{-- <img
                        src="../../assets/images/users/userworking.png"
                        alt="user"
